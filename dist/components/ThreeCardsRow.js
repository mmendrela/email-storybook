...
class ThreeCardsRow {
    ...
    render() {
        const { title, products, buttonText = 'Shop Now', ...styleProps } = this.props;
        ...
        const productsSection = new Section_1.Section({
            backgroundColor: '#ffffff',
...
exports.ThreeCardsRow = ThreeCardsRow;
