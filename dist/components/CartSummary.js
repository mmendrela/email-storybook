...
class CartSummary {
    ...
    render() {
        const { title = 'Your Order Summary', items, subtotal, shipping, tax, total, checkoutUrl, checkoutText = 'Complete Purchase', ...styleProps } = this.props;
      ...
      `
        ...
        const itemsSection = new Section_1.Section({
            backgroundColor: '#ffffff',
            padding: '20px 30px',
      ...
      `).join('')
        ...
        const summarySection = new Section_1.Section({
      ...
      `
        ...
        const checkoutSection = new Section_1.Section({
            padding: '30px',
            children: `
        <mj-column>
          <mj-button 
